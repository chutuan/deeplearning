                ...
                <table class="table table-striped table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                @if($order->status == \App\Order::STATUS_READY_DELIVERY)
                                <form action="/admin/orders/{{ $order->id }}/cancel-delivery" method="POST">
                                    <input name="_method" type="hidden" value="PUT">
                                    {{ csrf_field() }}
                                    <button class="btn btn-danger btn-sm">{{ __('Cancel Delivery') }}</button>
                                </form>
                                @endif
                            </td>
                        </tr>
