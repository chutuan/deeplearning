                ...
                <table class="table table-striped table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="row">
                                    @if($order->status == \App\Order::STATUS_CLEANED)
                                    <form action="/admin/orders/{{ $order->id }}/assign-delivery" method="POST">
                                    ...
                                    <button class="btn btn-success btn-md">Assign Delivery</button>
                                    </form>
                                    @endif
                                </div>
                            </td>
