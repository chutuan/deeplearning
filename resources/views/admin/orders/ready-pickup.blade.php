                ...
                <table class="table table-striped table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                @if($order->status == \App\Order::STATUS_READY_PICKUP)
                                <form action="/admin/orders/{{ $order->id }}/cancel-pickup" method="POST">
                                    <input name="_method" type="hidden" value="PUT">
                                    {{ csrf_field() }}
                                    <button class="btn btn-danger btn-sm">{{ __('Cancel Pickup') }}</button>
                                </form>
                                @endif
                            </td>
                        </tr>
